...
import { formalizeReply, summarizeEmail } from '../services/groq';
...
export function ChatScreen({ route, navigation }: Props) {
  ...
  // Get the most recent incoming email text for context
  ...
  // ─── Send casual reply for formalisation ───────────────────────────────────
  ...
  // ─── Auto-generate reply (Feature 12) ──────────────────────────────────────
  ...
  // ─── Confirm reply from Review Modal ───────────────────────────────────────
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        <View style={styles.shell}>
          ...
          {transforming && <TransformingAnimation />}
